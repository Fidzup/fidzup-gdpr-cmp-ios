...
internal extension CMPConsentString {
    ...
    internal static func encodeToBits(versionConfig: CMPVersionConfig,
        ...
        bits += CMPBitUtils.intToBits(editorVersion, numberOfBits: versionConfig.editorVersionBitSize)
        bits += CMPBitUtils.intToBits(vendorListVersion, numberOfBits: versionConfig.vendorListVersionBitSize)
        bits += purposesBitfield(versionConfig: versionConfig, allowedPurposes: editorPurposes)
    ...
    /**
     ...
     - allowedVendors: An array of allowed vendors id.
     - vendorListEncoding: The type of vendors encoding that should be used to generate the base64 consent string.
     - Returns: A base64 consent string corresponding to an IABConsentString.
     */
    internal static func iabEncodeToBits(versionConfig: CMPVersionConfig,
                                      created: Date,
                                      lastUpdated: Date,
                                      cmpId: Int,
                                      cmpVersion: Int,
